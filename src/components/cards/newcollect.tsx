const NewCollect = () => {
  return (
    <div className="lg:flex items-center justify-between w-[100%] mt-10">
      <div className="w-[360] sm:w-[460px] m-7 flex flex-col justify-center items-start">
        <h4 className="text-[24px] font-bold mb-4">Lorem ipsum </h4>
